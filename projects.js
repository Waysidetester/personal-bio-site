const projects = [
    ...
    {
        title: "Cool Project", 
        screenshot: "https://images.pexels.com/photos/248797/pexels-photo-248797.jpeg?cs=srgb&dl=beach-exotic-holiday-248797.jpg&fm=jpg", 
        alt: "Cat again",
        description: "This is the best project", // A good project description includes 'the what', 'the why', and 'the how'.
        technologiesUsed: "HTML, CSS, Vanilla JavaScript, Version Control with Github",
        available: true,
...
const createProjectCards = () => {
    ...
    for (i = 0; i < projects.length; i++) {
        if (projects[i].available) {
            ...
            newCard +=      `<a href="${projects[i].url}"><img src="${projects[i].screenshot}" alt="${projects[i].alt}"/></a>`;
